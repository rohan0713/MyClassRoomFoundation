...
public class student_assignments extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        id = (String) userHelperClass.get(student_assignments.this, "id", "id");
        Log.d("id", id);
        LinearLayoutManager layoutManager = new LinearLayoutManager
                (student_assignments.this, LinearLayoutManager.VERTICAL,false);
        ...
        call.enqueue(new Callback<List<assignmentModel>>() {
            ...
            public void onResponse(Call<List<assignmentModel>> call, Response<List<assignmentModel>> response) {
                ...
                if (sub.size() != 0) {
                    ...
                    recyclerView.setAdapter(new subAdapter(sub, 2));
                }else{
                    progress.setVisibility(View.GONE);
